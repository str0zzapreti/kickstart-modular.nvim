...
vim.keymap.set('n', '<leader>ff', require('telescope.builtin').find_files, { desc = '[F]ile [F]inder' })
vim.keymap.set('n', '<leader>fo', require('telescope.builtin').find_files, { desc = '[F]ile [O]pen' })
